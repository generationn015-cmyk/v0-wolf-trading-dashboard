...
import { getFullState, updateMarketData } from '@/lib/wolf-store'

export async function GET() {
  const s = await getFullState()
  return NextResponse.json({ success: true, data: s.marketData, timestamp: new Date().toISOString() })
}
